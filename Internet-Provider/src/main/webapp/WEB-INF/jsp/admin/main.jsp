...
<!doctype html>
<html>
<c:set var="title" value="Панель адміністратора" scope="page"/>
...
<div class="container">
    <div class="card mt-3 mb-3">
        ...
        <div class="card-body">
            <div class="row">
                <%-- Вертикальні таби Послуги|Абоненти --%>
                <div class="col-2">
                ...
                <%-- Горизонтальні таби Інтернет|Цифрове ТВ (IPTV)|Телефонний звязок|Новий тариф --%>
                <div class="col-10">
